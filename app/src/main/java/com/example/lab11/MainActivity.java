    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_query.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Cursor c;
                c  = (ed_book.length()<1)?dbrw.rawQuery("SELECT * FROM myTable",null):dbrw.rawQuery("SELECT * FROM myTable WHERE book LIKE '"+ed_book.getText().toString()+"'",null);
                c.moveToFirst();
                items.clear();
            ...
            public void onClick(View view) {
                if(ed_book.length()<1 || ed_price.length()<1)
                    ...
                    try {
                        ...
                        Toast.makeText(MainActivity.this,"新書名"+ed_book.getText().toString()+"      價格"+ed_price.getText().toString(),Toast.LENGTH_SHORT).show();
                        ed_book.setText("");
                        ed_price.setText("");
                    }catch(Exception e){
